...
func _inject_hell_sprites() -> void:
    ...
    var hell := {
        ...
        "chest_gold": [   # ЗОЛОТОЙ сундук — редкий, с жирным лутом
            "................",
            ".....w.....w....",
            "...kkkkkkkkkk...",
            "..kyyyyyyyyyyk..",
        ...
        "magma_golem": [   # Магмовый Голем — камень с прожилками лавы
            "................",
            "....dddddddd....",
            "...ddddddddddd..",
            "...ddroorddddd..",
        ...
        "ash_ghost": [   # Призрак Забоя — пепельный дух с киркой
            "................",
            "......NNNN......",
            ".....NNNNNN.....",
            "....NNNNNNNN....",
    ...
    var kw := [["зольный", "ash_bug"], ["уголёк", "ember"],
               ...
               ["магистр пекла", "pekl_master"],
               ["кринж-мышь", "hell_bat"], ["голем", "magma_golem"],
               ["бес", "hell_demon"], ["забоя", "ash_ghost"],
               ["слизень", "sliz"], ["крыса-кринж", "krysa"],
               ["шлаковый паук", "pauk"],
               ["тм", "tm"]]
